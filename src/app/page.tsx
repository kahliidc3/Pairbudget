            ...
            >
              <div>
                <motion.h1 
                  ...
                  className="text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-600 via-blue-600 to-orange-500 bg-clip-text text-transparent leading-tight"
                >
                  Expense Tracking
                  <br />
              ...
              >
                <div className="text-center lg:text-left">
                  ...
                  <div className="text-sm text-gray-600">People per Pocket</div>
                </div>
                <div className="text-center lg:text-left">
            ...
            >
              <div className="relative">
                ...
                <motion.div 
                  ...
                  className="card-3d max-w-sm w-full"
                >
                  <div className="text-center mb-6">
                    <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                      <Wallet className="w-8 h-8 text-white" />
                    </div>
                    <h3 className="text-title mb-2">Family Budget</h3>
                    <p className="text-gray-600">Shared Pocket</p>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-white/50 rounded-lg">
                      <span className="text-sm text-gray-600">Balance</span>
                      <span className="font-semibold text-green-600">$1,247.50</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white/50 rounded-lg">
                      <span className="text-sm text-gray-600">This Month</span>
                      <span className="font-semibold text-blue-600">$892.30</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white/50 rounded-lg">
                      <span className="text-sm text-gray-600">Expenses</span>
                      <span className="font-semibold text-orange-600">$654.80</span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-4 -left-8 card-floating p-4 bg-white/90 max-w-xs"
                >
                  <div className="flex items-center space-x-3">
                ...
                <motion.div 
                  ...
                  className="absolute -top-4 -right-8 card-floating p-4 bg-white/90 max-w-xs"
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-sm">-$89.50</p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="card-grid-asymmetric">
              ...
              >
                ...
                <h3 className="text-title mb-4">Two-Person Focus</h3>
              ...
              >
                ...
                <h3 className="text-title mb-4">Real-time Sync</h3>
                <p className="text-gray-600">
              ...
              >
                ...
                <h3 className="text-title mb-4">Secure & Private</h3>
                <p className="text-gray-600">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="card-floating">
              ...
              <button
                ...
                className="btn-primary text-lg px-10 py-4 mx-auto flex items-center space-x-3 group"
              >

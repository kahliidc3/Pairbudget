        ...
        >
          <div className="flex items-center justify-between px-3 md:px-4">
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              <span className="font-semibold text-gray-800 text-sm md:text-base">{tNav('pairbudget')}</span>
            </div>
            ...
            >
              ...
              >
                <div className="text-center lg:text-left">
                  ...
                  <div className="text-xs md:text-sm text-gray-600">{t('quickStats.peoplePerPocket')}</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-2xl md:text-3xl font-bold text-blue-600 mb-1 md:mb-2">∞</div>
                  <div className="text-xs md:text-sm text-gray-600">{t('quickStats.transactions')}</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-2xl md:text-3xl font-bold text-orange-600 mb-1 md:mb-2">24/7</div>
                  <div className="text-xs md:text-sm text-gray-600">{t('quickStats.realTimeSync')}</div>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="relative">
                ...
                >
                  <div className="text-center mb-4 md:mb-6">
                    ...
                    <h3 className="text-lg md:text-xl font-semibold mb-1 md:mb-2">{t('pocket.familyBudget')}</h3>
                    <p className="text-sm md:text-base text-gray-600">{t('pocket.sharedPocket')}</p>
                  </div>
                  
                  <div className="space-y-3 md:space-y-4">
                    <div className="flex justify-between items-center p-2 md:p-3 bg-white/50 rounded-lg">
                      <span className="text-xs md:text-sm text-gray-600">{t('pocket.balance')}</span>
                      <span className="font-semibold text-green-600 text-sm md:text-base">$1,247.50</span>
                    </div>
                    <div className="flex justify-between items-center p-2 md:p-3 bg-white/50 rounded-lg">
                      <span className="text-xs md:text-sm text-gray-600">{t('pocket.thisMonth')}</span>
                      <span className="font-semibold text-blue-600 text-sm md:text-base">$892.30</span>
                    </div>
                    <div className="flex justify-between items-center p-2 md:p-3 bg-white/50 rounded-lg">
                      <span className="text-xs md:text-sm text-gray-600">{t('pocket.expenses')}</span>
